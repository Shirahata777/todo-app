...
export { default as SaveForm } from '../../components/save/save-form.vue'
...
export const LazySaveForm = import('../../components/save/save-form.vue' /* webpackChunkName: "components/save-form" */).then(c => wrapFunctional(c.default || c))
