...
export { default as UiTodoCardList } from '../../components/ui/todo-card-list.vue'
...
export const LazyUiTodoCardList = import('../../components/ui/todo-card-list.vue' /* webpackChunkName: "components/ui-todo-card-list" */).then(c => wrapFunctional(c.default || c))
